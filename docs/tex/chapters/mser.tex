...
wzrostu osiąga lokalne minimum. \todo{parametry min i max} \todo{dlaczego tekstura zła}
...
zawierają: \begin{inparaenum}[\itshape a\upshape)] \item poziom jasności komponentu, \item tablicę
