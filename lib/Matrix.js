(function(){
  ...
  Matrix.prototype.eigenvector = function(){
    var v = this.jacobi()[1].arr[0];
    var last = v[v.length-1]
    var norm = last == 0 ? 1 : 1/last;
  ...
  Matrix.prototype.jacobi = function(){
    ...
    var arr = this.arr;
    var arr2 = this.arr.map(function(row){ return row.slice(0) }).slice(0); // javascript's way of cloning :/
